...
public class CadastroClientes extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        alterar_Clientes = new javax.swing.JButton();
        buttonLimpar1 = new javax.swing.JButton();
        buttonMenu = new javax.swing.JButton();
        buttonRemoverPF = new javax.swing.JButton();
        ...
        ContatoFisica = new javax.swing.JLabel();
        TextoContatosFisica = new javax.swing.JTextField();
        ...
        alterar_Clientes.setText("Alterar");
        alterar_Clientes.setPreferredSize(new java.awt.Dimension(81, 23));
        alterar_Clientes.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                alterar_ClientesActionPerformed(evt);
            }
        });
        ...
        buttonRemoverPF.setText("Remover");
        buttonRemoverPF.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                buttonRemoverPFActionPerformed(evt);
            }
        });
                    ...
                    .addGroup(pessoaJuridicaLayout.createSequentialGroup()
                        ...
                        .addGroup(pessoaJuridicaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(pessoaJuridicaLayout.createSequentialGroup()
                                ...
                                .addComponent(alterar_Clientes, javax.swing.GroupLayout.PREFERRED_SIZE, 94, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(18, 18, 18)
        ...
        pessoaJuridicaLayout.setVerticalGroup(
            ...
            .addGroup(pessoaJuridicaLayout.createSequentialGroup()
                ...
                .addGap(40, 40, 40)
                .addGroup(pessoaJuridicaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(alterar_Clientes, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    ...
                    .addGroup(pessoaFisicaLayout.createSequentialGroup()
                        .addGroup(pessoaFisicaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(pessoaFisicaLayout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addComponent(buttonRemover, javax.swing.GroupLayout.PREFERRED_SIZE, 87, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                            ...
                            .addGroup(pessoaFisicaLayout.createSequentialGroup()
                                .addGroup(pessoaFisicaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(pessoaFisicaLayout.createSequentialGroup()
                                        .addGroup(pessoaFisicaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            .addComponent(ContatoFisica, javax.swing.GroupLayout.PREFERRED_SIZE, 94, javax.swing.GroupLayout.PREFERRED_SIZE)
                                ...
                                .addGroup(pessoaFisicaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(TextoContatosFisica, javax.swing.GroupLayout.PREFERRED_SIZE, 271, javax.swing.GroupLayout.PREFERRED_SIZE))))
        ...
        pessoaFisicaLayout.setVerticalGroup(
            ...
            .addGroup(pessoaFisicaLayout.createSequentialGroup()
                ...
                .addGroup(pessoaFisicaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(pessoaFisicaLayout.createSequentialGroup()
                        .addGap(16, 16, 16)
                        .addComponent(ContatoFisica, javax.swing.GroupLayout.PREFERRED_SIZE, 28, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(pessoaFisicaLayout.createSequentialGroup()
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(TextoContatosFisica, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void cadastroClientesMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_cadastroClientesMouseClicked
        ...
        if (selectedRow >= 0) {
            ...
            if (tipoPessoaCombox.getSelectedIndex() == 0) { // Pessoa Física
                ...
                TextoContatosFisica.setText(model.getValueAt(selectedRow, 5).toString());
            } else if (tipoPessoaCombox.getSelectedIndex() == 1) { // Pessoa Jurídica
    ...
    private void buttonRemoverPFActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonRemoverPFActionPerformed
...
//lembrar de fazer o update botton de pf
    private void alterar_ClientesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_alterar_ClientesActionPerformed
...
// Torna a janela atual invisível
    ...
    private void alterar_cliente2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_alterar_cliente2ActionPerformed
        ...
        String novosContatos = TextoContatosFisica.getText(); // O campo de contatos é opcional
        ...
        if (cliente != null) {
            ...
            cliente.setEndereco(novoEndereco);
            cliente.setEmail(novoEmail);
            cliente.setContatos(novosContatos); // Atualiza os contatos (opcional)
            ...
            if (i >= 0) {
                ...
                model.setValueAt(novosContatos, i, 5); // Atualiza contatos
            }
    ...
    private void adicionarFisicaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_adicionarFisicaActionPerformed
        ...
        String contatos = TextoContatosFisica.getText();
        if (!Validator.validarEntradaPF(nome, cpf, telefones, endereco, email, contatos)) {
            return;
        }
        ...
        // Adiciona o cliente à lista e atualiza a tabela
        clienteController.adicionarCliente(cliente, model);
        //usando para verificar se uuid esta criando o id msm nao mostrando na tela 
        System.out.println(cliente.getID()); // Exibe o ID gerado
    ...
    private javax.swing.JLabel ContatoFisica;
    ...
    private javax.swing.JTextField TextoContatosFisica;
    ...
    private javax.swing.JButton alterar_Clientes;
